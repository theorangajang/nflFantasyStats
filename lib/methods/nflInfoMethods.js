...
export let getThisWeeksStats = (res) => {
    axios.get(yahooScoreBoard)
        .then(response => {
            getCurrentWeekData(response);
...
let getQBStats = (statsLink) => {
    return axios.get(statsLink)
        .then(response => {
            let playerInfo = [];
            let $ = cherrio.load(response.data);
        ...
        .then((info) => {
            info.map((specificPlayerInfo, index) => {
                ...
                //Name
                qbPlayer['name'] = playerIndex[0]['children'][0]['children'][0]['children'][0]['data'];
    ...
    axios.get(rbLink)
        ...
        .then((info) => {
            info.map((specificPlayerInfo, index) => {
                ...
                let playerIndex = info[index];
                //Name
                rbPlayer['name'] = playerIndex[0]['children'][0]['children'][0]['children'][0]['data'];
    ...
    axios.get(wrLink)
        ...
        .then((info) => {
            info.map((specificPlayerInfo, index) => {
                ...
                //Name
                wrPlayer['name'] = playerIndex[0]['children'][0]['children'][0]['children'][0]['data'];
    ...
    axios.get(defLink)
        ...
        .then((info) => {
            info.map((specificPlayerInfo, index) => {
                ...
                let playerIndex = info[index];
                //Name
                defPlayer['name'] = playerIndex[0]['children'][0]['children'][0]['children'][0]['data'];
